...
def setup_input_db(db_name='./brand.db'):
    ...
    input_list = [('Brandborg', 10, 'sword'),
                  ('Arash', 5, 'sword'),
                  ('Mathias', 100, 'mind games'),
                  ('Mikael', 5, 'sword')]
...
def setup_input_csv(csv_name='./weapon.csv'):
    """ This function sets up the input CSV required
    """
    with open(csv_name, 'w+') as file:
        file.write('weapon,type\n')
        file.write('sword, sharp\n')
        file.write('mind games, psychic\n')
